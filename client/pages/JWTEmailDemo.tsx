    ...
    <div className="container mx-auto py-8 px-4 max-w-6xl">
      <div className="mb-8 text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Test Nodemailer + JWT token-based email verification and password reset system
        </p>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setVerificationForm(prev => ({ ...prev, token: e.target.value }))}
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setVerificationForm(prev => ({ ...prev, code: e.target.value }))}
                        placeholder="123456"
                        maxLength={6}
                      />
                    </div>
                    ...
                    <Button 
                      ...
                      disabled={loading || !verificationForm.email || !verificationForm.code}
                      className="w-full"
                    >
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setPasswordResetForm(prev => ({ ...prev, token: e.target.value }))}
                    ...
                    <Button 
                      ...
                      disabled={loading || !passwordResetForm.token || !passwordResetForm.newPassword}
                      className="w-full"
                    >
                      {loading ? <Loader2 className="w-4 h-4 mr-2 animate-spin" /> : <Lock className="w-4 h-4 mr-2" />}
                      Reset Password
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setRegistrationForm(prev => ({ ...prev, bio: e.target.value }))}
                  ...
                  <Button 
                    ...
                    disabled={loading || !registrationForm.email || !registrationForm.username || !registrationForm.name || !registrationForm.password}
                    className="w-full"
                  >
                    {loading ? <Loader2 className="w-4 h-4 mr-2 animate-spin" /> : <Mail className="w-4 h-4 mr-2" />}
                    Register with Email Verification
            ...
            <CardContent>
              {results ? (
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={() => copyToClipboard(results.verificationLink)}
                        >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={() => copyToClipboard(results.verificationToken)}
                        >
                          <Copy className="w-4 h-4" />
                        </Button>
                      </div>
                ...
                <div className="text-center text-muted-foreground py-8">
                  ...
                  <p className="text-xs">Make an API call to see results here</p>
                </div>
              )}
            </CardContent>
          </Card>
      ...
      <Card className="mt-6">
        ...
        <CardContent>
          <div className="space-y-2 text-sm font-mono">
            <div><strong>POST</strong> /api/v4/auth/verification/email/send</div>
            <div><strong>POST</strong> /api/v4/auth/verification/email/verify-token</div>
            <div><strong>POST</strong> /api/v4/auth/verification/email/verify-code</div>
            <div><strong>POST</strong> /api/v4/auth/verification/email/resend</div>
            <div><strong>POST</strong> /api/v4/auth/password/forgot</div>
            <div><strong>POST</strong> /api/v4/auth/password/reset-with-token</div>
            <div><strong>POST</strong> /api/v4/auth/register/email-verification</div>
            <div><strong>POST</strong> /api/v4/auth/login/enhanced</div>
          </div>
        </CardContent>
      </Card>
    </div>

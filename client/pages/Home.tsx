      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            className="w-10 h-10 bg-gradient-to-r dark:from-neon-green dark:to-purple-secondary light:bg-gray-200 rounded-full flex items-center justify-center shadow-lg hover:shadow-lg dark:hover:shadow-neon-green/60 light:hover:shadow-md transition-all duration-300 relative overflow-hidden"
          >
          ...
          >
            ...
            <motion.span
              ...
              className="absolute -top-1 -right-1 w-4 h-4 bg-neon-green dark:bg-neon-green light:bg-red-500 rounded-full flex items-center justify-center text-xs font-bold text-white shadow-lg dark:shadow-neon-green/50 light:shadow-md"
            >
              3
            </motion.span>
            <motion.div

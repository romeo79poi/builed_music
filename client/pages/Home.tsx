        ...
        <main className="flex-1 overflow-y-auto pb-24 px-4 space-y-6">
          ...
          <motion.div variants={itemVariants} className="mb-12 mt-8 text-center">
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-4 text-foreground"
            >
              {getGreeting()}
            </motion.h1>
            <motion.p
            ...
            <div className="flex space-x-4 overflow-x-auto scrollbar-hide pb-4">
              {newReleases.map((release, index) => (
                <motion.div
                  ...
                  className="flex-shrink-0 w-40 bg-gray-500 rounded-xl p-4 hover:bg-gray-400 transition-all cursor-pointer claude-shadow hover:claude-shadow-hover dark:claude-dark-shadow dark:hover:claude-dark-shadow-hover"
                >
            ...
            <div className="flex space-x-4 overflow-x-auto scrollbar-hide pb-4">
              {sampleAlbums.map((album, index) => (
                <motion.div
                  ...
                  className="flex-shrink-0 w-32 sm:w-36 bg-gray-500 rounded-xl p-3 hover:bg-gray-400 transition-all cursor-pointer group claude-shadow hover:claude-shadow-hover dark:claude-dark-shadow dark:hover:claude-dark-shadow-hover theme-transition"
                >
                  <div className="relative mb-3">
                    <motion.img

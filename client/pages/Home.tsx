      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            className="w-10 h-10 bg-gradient-to-r dark:from-neon-green dark:to-purple-secondary light:bg-gradient-to-r light:from-purple-primary light:to-purple-secondary rounded-full flex items-center justify-center shadow-lg hover:shadow-lg dark:hover:shadow-neon-green/60 light:hover:shadow-purple-primary/30 transition-all duration-300 relative overflow-hidden"
          >
          ...
          <motion.button
            ...
            initial="initial"
            animate="animate"
            className="w-10 h-10 bg-gradient-to-r dark:from-purple-primary dark:to-purple-secondary light:bg-gradient-to-r light:from-purple-primary light:to-purple-accent rounded-full flex items-center justify-center shadow-lg dark:hover:shadow-purple-primary/60 light:hover:shadow-purple-primary/30 transition-all duration-300 relative overflow-hidden"
          >
        ...
        <main className="flex-1 overflow-y-auto pb-24 px-4 space-y-6">
          ...
          <motion.div variants={itemVariants} className="mb-8">
            ...
            >
              <Sparkles className="w-4 h-4 text-muted-foreground dark:text-muted-foreground light:text-purple-primary" />
          ...
          <motion.section variants={itemVariants} className="mb-8">
            <div className="flex items-center justify-between mb-4">
              ...
              >
                <Sparkles className="w-5 h-5 text-foreground dark:text-foreground light:text-purple-primary" />
                <span>New Releases</span>
              </motion.h2>
              <motion.button
                whileHover={{ scale: 1.05 }}
                className="text-gray-400 dark:text-gray-400 light:text-gray-600 hover:text-white dark:hover:text-white light:hover:text-purple-primary text-sm font-medium transition-colors"
              >
                See all
              </motion.button>
            </div>
          ...
          <motion.section variants={itemVariants}>
            <div className="flex items-center justify-between mb-4">
              <motion.h2
                ...
                className="text-xl font-bold flex items-center space-x-2"
              >
                <Music className="w-5 h-5 text-foreground dark:text-foreground light:text-purple-primary" />
                <span>Popular Songs</span>
              </motion.h2>
              <motion.button
                whileHover={{ scale: 1.05 }}
                className="text-gray-400 dark:text-gray-400 light:text-gray-600 hover:text-white dark:hover:text-white light:hover:text-purple-primary text-sm font-medium transition-colors flex items-center space-x-1"
              >
                <span>Show all</span>

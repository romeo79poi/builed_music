      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            className="w-10 h-10 bg-gradient-to-r dark:from-neon-green dark:to-purple-secondary light:bg-black rounded-full flex items-center justify-center shadow-lg hover:shadow-lg dark:hover:shadow-neon-green/60 light:hover:shadow-md transition-all duration-300 relative overflow-hidden"
          >
          ...
          >
            ...
            <motion.span
              ...
              className="absolute -top-1 -right-1 w-4 h-4 bg-neon-green dark:bg-neon-green light:bg-green-500 rounded-full flex items-center justify-center text-xs font-bold text-white shadow-lg dark:shadow-neon-green/50 light:shadow-green-500/30"
            >
              3
            </motion.span>
            <motion.div
        ...
        <main className="flex-1 overflow-y-auto pb-24 px-4 space-y-6">
            ...
            <div className="relative">
              ...
              >
                ...
                <input
                  ...
                  className="w-full h-14 bg-white/10 dark:bg-white/10 light:bg-blue-50/80 backdrop-blur-sm rounded-2xl pl-12 pr-4 text-white dark:text-white light:text-gray-900 placeholder-gray-400 dark:placeholder-gray-400 light:placeholder-gray-500 focus:outline-none focus:bg-white/15 dark:focus:bg-white/15 light:focus:bg-white border border-purple-primary/20 dark:border-purple-primary/20 light:border-blue-200 focus:border-blue-500 dark:focus:border-purple-primary/50 light:focus:border-blue-500 transition-all theme-transition"
                />
              </motion.div>
            </div>
          </motion.div>
          ...
          <motion.section variants={itemVariants} className="mb-8">
            <div className="flex items-center justify-between mb-4">
              ...
              >
                <Sparkles className="w-5 h-5 text-foreground dark:text-foreground light:text-blue-600" />
          ...
          <motion.section variants={itemVariants}>
            <div className="flex items-center justify-between mb-4">
              <motion.h2
                ...
                className="text-xl font-bold flex items-center space-x-2"
              >
                <Music className="w-5 h-5 text-foreground dark:text-foreground light:text-blue-600" />
                <span>Popular Songs</span>
              </motion.h2>
              <motion.button
                whileHover={{ scale: 1.05 }}
                className="text-gray-400 dark:text-gray-400 light:text-gray-600 hover:text-white dark:hover:text-white light:hover:text-blue-600 text-sm font-medium transition-colors flex items-center space-x-1"
              >
                <span>Show all</span>

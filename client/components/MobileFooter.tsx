                      ...
                      <>
                        ...
                        {isActive && (
                          <motion.div
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
                            className="absolute inset-0 bg-gradient-to-r dark:from-neon-green/20 dark:to-purple-secondary/20 light:from-purple-primary/20 light:to-purple-secondary/20 rounded-full border dark:border-neon-green/30 light:border-purple-primary/30"
                          />
                        )}
                        ...
                        <Icon
                          className={`w-6 h-6 relative z-10 transition-all duration-300 ${
                            isActive
                              ? "text-neon-green dark:text-neon-green light:text-purple-primary scale-110"
                            : "text-gray-400 dark:text-gray-400 light:text-gray-600 group-hover:text-purple-primary dark:group-hover:text-purple-primary light:group-hover:text-purple-primary"
                          }`}
                        />
                      </>
                    )}
